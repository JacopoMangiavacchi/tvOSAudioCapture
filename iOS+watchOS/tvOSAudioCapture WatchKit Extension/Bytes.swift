...
extension Message {
    public func pack() throws -> Data {
        ...
        let flag1 = UInt16(header.response ? 1 : 0) << 15
        let flag2 = UInt16(header.operationCode.rawValue) << 11
        let flag3 = UInt16(header.authoritativeAnswer ? 1 : 0) << 10
        let flag4 = UInt16(header.truncation ? 1 : 0) << 9
        let flag5 = UInt16(header.recursionDesired ? 1 : 0) << 8
        let flag6 = UInt16(header.recursionAvailable ? 1 : 0) << 7
        let flag7 = UInt16(header.returnCode.rawValue)

        let flags: UInt16 = flag1 | flag2 | flag3 | flag4 | flag5 | flag6 | flag7
